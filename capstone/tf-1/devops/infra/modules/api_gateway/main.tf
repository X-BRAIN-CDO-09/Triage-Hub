...
Action=SendMessage&MessageBody=$util.urlEncode($input.body)#if($input.params('X-Tenant-Id') != "")&MessageAttribute.$${attributeIndex}.Name=TenantId&MessageAttribute.$${attributeIndex}.Value.DataType=String&MessageAttribute.$${attributeIndex}.Value.StringValue=$util.urlEncode($input.params('X-Tenant-Id'))#set($attributeIndex = $attributeIndex + 1)#end#if($input.params('X-Correlation-Id') != "")&MessageAttribute.$${attributeIndex}.Name=CorrelationId&MessageAttribute.$${attributeIndex}.Value.DataType=String&MessageAttribute.$${attributeIndex}.Value.StringValue=$util.urlEncode($input.params('X-Correlation-Id'))#set($attributeIndex = $attributeIndex + 1)#end#if($input.params('X-Source') != "")&MessageAttribute.$${attributeIndex}.Name=Source&MessageAttribute.$${attributeIndex}.Value.DataType=String&MessageAttribute.$${attributeIndex}.Value.StringValue=$util.urlEncode($input.params('X-Source'))#end
    EOT
  }
