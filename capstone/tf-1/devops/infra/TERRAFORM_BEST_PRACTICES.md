...
*Nếu bạn là một AI Code Assistant / Agent đang đọc file này, bạn được lập trình để tuân thủ các quy định sau:*
...
Dùng `count` khiến Terraform định danh resource bằng *Index* (0, 1, 2). Khi thêm/xóa phần tử ở giữa danh sách, toàn bộ resource phía sau sẽ bị destroy & recreate.
